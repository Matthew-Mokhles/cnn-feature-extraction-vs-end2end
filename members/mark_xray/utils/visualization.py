"""utils/visualization.py — Mark's local copy."""
import os
import numpy as np
...
def plot_training_curves(history, title="Training History", save_path=None, figsize=(13, 5)):
...
def plot_comparison_bar(models_dict, title="Model Comparison", save_path=None, figsize=(12, 6)):
    metrics = ["accuracy", "precision", "recall", "f1"]
    labels  = ["Accuracy", "Precision", "Recall", "F1-Score"]
    n_models = len(models_dict); bar_w = 0.8 / n_models
